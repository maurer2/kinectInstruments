...
public class TabTest extends PApplet {
	...
	public void setup() {
		...
		cp5.addTab("extra").setColorBackground(color(0, 160, 100)).setColorLabel(color(255))
				.setColorActive(color(255, 128, 0));
		
		cp5.addTab("extra2").setColorBackground(color(0, 160, 100)).setColorLabel(color(255))
		.setColorActive(color(255, 128, 0));
		...
		cp5.getController("slider").moveTo("extra2");
